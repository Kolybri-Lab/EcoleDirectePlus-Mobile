...
import mockSchoollife from "./schoollife.json";
import mockTimeline from "./timeline.json";
import mockTimelineGet from "./timeline_get.json";
import mockTimetable from "./timetable.json";
import mockViescolaireGet from "./viescolaire_get.json";
